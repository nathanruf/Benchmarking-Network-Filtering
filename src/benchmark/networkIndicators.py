...
class NetworkIndicators():
    ...
    def calculate_network_similarity(self, network1: Union[nx.Graph, nx.DiGraph], 
    ...
    def calculate_jaccard_distance(self, network1: Union[nx.Graph, nx.DiGraph], network2: Union[nx.Graph, nx.DiGraph]) -> float:
        """
